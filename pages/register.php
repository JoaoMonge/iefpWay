            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-sm-6 col-sm-offset-3 form-box">
                        ...
                        //Se os campos estiverem preenchidos este faz duas opções ou dá erro ou faz a query
                        //form-card-number
                        ...
                        && isset($_POST["form-card-number"])  && isset($_POST["form-card-name"])  && isset($_POST["form-card-csv"])  && isset($_POST["form-card-expiration"])
                            ...
                            //Dá erro caso a password não seja igual a Confirmação da password
                            if($_POST["form-password"] != $_POST["form-confirm-password"]){
                                ...
                                //Query para inserir os dados de um novo utilizador na base de dados
                                ...
                                $sql = $conn->prepare("INSERT INTO User(name,email,contact,password,card_id) VALUES (?,?,?,?,?);");
                                $sql->bind_param("ssssd", $_POST["form-username"], $_POST["form-email"], $_POST["form-contact"],$_POST["form-password"],$cardId);
                                $sql->execute();
